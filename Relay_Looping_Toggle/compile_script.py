...
files_to_compile = ['Relay_LoopingToggle']
directories = []
file_to_compile = 'Relay_LoopingToggle'
if len(sys.argv) == 2:
    com_port = 'com4'
else:
	com_port = sys.argv[2]
...
path_win_avr = 'C:/Users/ianwp/OneDrive/Documents/Miami_2023-2024/Second_Semester/ECE_484/avr_gcc/avr_gcc/bin/'
